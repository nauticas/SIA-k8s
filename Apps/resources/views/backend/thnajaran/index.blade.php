        ...
        <div class="content table-responsive table-full-width">
            <table class="table table-striped">
                <thead>
                    ...
                    <th>Status</th>
                    <th>Aksi</th>
                    <th><a href="{{route('thnajaran.create')}}" class="btn btn-success"><span class="fa fa-plus"></span> Tambah thnajaran</a></th>
                </thead>
                <tbody>
                    ...
                    <form action="{{route('thnajaran.destroy',$ta->id)}}" method="post"  class="form-inline">
                        <tr>
                            ...
                            <td>{{$ta->statuta}}</td>
                            <td colspan="2">
                                <a href="{{route('thnajaran.edit',$ta->id)}}" class="btn btn-info"><i class="fa fa-pencil"></i></a>
                                {{ csrf_field() }}
