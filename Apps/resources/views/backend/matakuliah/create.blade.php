	...
	<div class="box">
		...
		<div class="content">
			<form action="{{route('matakuliah.store')}}" method="POST">
				...
				<div class="row">
					<div class="col-md-5">
						<div class="form-group @if($errors->has('kd_mk')) has-error @endif">
							<label>Kode MK</label>
							<input type="text" class="form-control border-input" value="{{old('kd_mk')}}" name="kd_mk">
					...
					<div class="col-md-5">
						<div class="form-group @if($errors->has('sks')) has-error @endif">
							<label>SKS</label>
							<input type="text" class="form-control border-input" value="{{old('sks')}}" name="sks">
				...
				<div class="row">
					<div class="col-md-10">
						<div class="form-group @if($errors->has('nama_mk')) has-error @endif">
							...
							<input type="text" class="form-control border-input" value="{{old('nama_mk')}}" name="nama_mk">
				...
				<div class="row">
					<div class="col-md-5">
						<div class="form-group @if($errors->has('semester')) has-error @endif">
							...
							<input type="text" class="form-control border-input" value="{{old('semester')}}" name="semester">
					...
					<div class="col-md-5">
						<div class="form-group @if($errors->has('prasyarat_mk')) has-error @endif">
							...
							<select class="form-control border-input" name="prasyarat_mk">
								<option value="" {{old('prasyarat_mk') == '' ? 'selected' : ''}}>Tidak Ada</option> 
								@foreach($prasyarat as $kMk => $vMk)
								<option value="{{$kMk}}" {{old('prasyarat_mk') == $kMk ? 'selected' : ''}}>{{$vMk}}</option>
								@endforeach
							</select>
				...
				<div class="row">
					<div class="col-md-12">
						<a href="{{ route('matakuliah.index') }}" class="btn btn-warning">Cancel</a>
