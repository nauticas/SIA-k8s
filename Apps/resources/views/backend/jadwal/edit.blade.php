	...
	<div class="box">
		...
		<div class="content">
			<form action="{{route('jadwal.update',$jadwal->id)}}" method="POST">
					...
					<div class="col-md-5">
						<div class="form-group @if($errors->has('mk_id')) has-error @endif">
							...
							<select class="form-control border-input" name="mk_id">
								...
								<option value="{{$mkK}}" {{$jadwal->mk_id == $mkK ? 'selected' : ''}}>{{$mkV}}</option>
								@endforeach
							</select>
					...
					<div class="col-md-5">
						<div class="form-group @if($errors->has('dosen_id')) has-error @endif">
							...
							<select class="form-control border-input" name="dosen_id">
								...
								<option value="{{$dosenK}}" {{$jadwal->dosen_id == $dosenK ? 'selected' : ''}}>{{$dosenV}}</option>
								@endforeach
							</select>
				...
				<div class="row">
					<div class="col-md-5">
						<div class="form-group @if($errors->has('hari')) has-error @endif">
							...
							<select class="form-control border-input" name="hari">
								...
								<option value="{{$hK}}" {{$jadwal->hari == $hK ? 'selected' : ''}}>{{$hV}}</option>
								@endforeach
							</select>
					...
					<div class="col-md-2">
						<div class="form-group @if($errors->has('waktu_mulai')) has-error @endif">
							...
							<input type="text" class="form-control border-input" value="{{$jadwal->waktu_mulai}}" name="waktu_mulai">
					...
					<div class="col-md-2">
						<div class="form-group @if($errors->has('waktu_selesai')) has-error @endif">
							...
							<input type="text" class="form-control border-input" value="{{$jadwal->waktu_selesai}}" name="waktu_selesai">
					...
					<div class="col-md-5">
						<div class="form-group @if($errors->has('ruang_id')) has-error @endif">
							...
							<select class="form-control border-input" name="ruang_id">
								...
								<option value="{{$ruangK}}" {{$jadwal->ruang_id == $ruangK ? 'selected' : ''}}>{{$ruangV}}</option>
								@endforeach
							</select>
					...
					<div class="col-md-5">
						<div class="form-group @if($errors->has('thnajaran_id')) has-error @endif">
							...
							<select class="form-control border-input" name="thnajaran_id">
								...
								<option value="{{$thnajaranK}}" {{$jadwal->thnajaran_id == $thnajaranK ? 'selected' : ''}}>{{$thnajaranV}}</option>
								@endforeach
							</select>
				...
				<div class="row">
					<div class="col-md-5">
						<div class="form-group @if($errors->has('kapasitas')) has-error @endif">
							...
							<input type="text" class="form-control border-input" value="{{$jadwal->kapasitas}}" name="kapasitas">
					...
					<div class="col-md-2">
						<div class="form-group @if($errors->has('program')) has-error @endif">
							...
							<select class="form-control border-input" name="program">
								@foreach($kelas as $kK)
								<option value="{{$kK}}" {{$jadwal->program == $kK ? 'selected' : ''}}>{{$kK}}</option>
								@endforeach
							</select>
					...
					<div class="col-md-2">
						<div class="form-group @if($errors->has('kelas')) has-error @endif">
							<label>Kelas</label>
							<input type="text" class="form-control border-input" value="{{$jadwal->kelas}}" name="kelas">
				...
				<div class="row">
					<div class="col-md-12">
						<a href="{{ route('jadwal.index') }}" class="btn btn-warning">Cancel</a>
