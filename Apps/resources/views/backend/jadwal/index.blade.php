...
<div class="col-md-12">
    <div class="box">
        ...
        <div class="content table-responsive">
            <a href="{{route('jadwal.create')}}" class="btn btn-success btn-xs"><span class="fa fa-plus"></span> Tambah Jadwal</a>
                ...
                <tbody>
                    ...
                    <form action="" method="post"  class="form-inline">
                        <tr>
                            ...
                            <td>
                                <a href="{{route('jadwal.edit',$jadwal->id)}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i></a>
                                {{ csrf_field() }}
